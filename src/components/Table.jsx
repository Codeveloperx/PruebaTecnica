    ...
    <table className="border-collapse w-full mt-4">
      <thead className="border-t border-b">
        <tr>
          ...
          <th className="text-sm font-bold text-gray-900 px-6 py-4 text-left hidden sm:table-cell">#Ciudades</th>
          <th className="text-sm font-bold text-gray-900 px-6 py-4 text-left hidden sm:table-cell">Actions</th>
        </tr>
      </thead>
      ...
      <tbody>
        <tr
          ...
          <td
        className="w-full sm:w-auto px-6 text-gray-800 border-b block sm:table-cell relative sm:static pr-8 text-right sm:text-left">
        <span className="sm:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">#Ciudades</span>
        {4}
    </td>
          <td
            className="w-full sm:w-auto px-6 text-gray-800 border-b block sm:table-cell relative sm:static pr-8 text-right sm:text-left">
            <span className="sm:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">Actions</span>
              <button>
                <img src={eye} alt="see" width='20' />
              </button>
          </td>
        </tr>
      </tbody>
